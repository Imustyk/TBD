...
MODEL_PATH = MODELS_DIR / "xgboost_popularity.joblib"
METRICS_PATH = MODELS_DIR / "xgboost_popularity_metrics.json"
...
TARGET_COLUMN = "book_popularity_target"
...
def train_model() -> dict[str, float]:
    ...
    categorical_features = ["category_name", "country", "activity_segment"]
